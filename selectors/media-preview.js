...
window.WA_BLUR_RULES.push({
  ...
  targets: [
    ...
    '[role="list"][aria-label="Media list"] [data-testid="media-canvas"] [data-testid="media-url-provider"] [data-testid="media-canvas-img"]',
  ...
  hoverParentTargets: [
    ...
    {
      hoverParent: '[role="list"][aria-label="Media list"] [data-testid="media-canvas"] > div',
